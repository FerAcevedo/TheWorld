        ...
        public async Task EnsureSeedDataAsync()
        {
            ...
            if (!_context.Trips.Any())
            {
                ...
                var usTrip = new Trip()
                {
                    ...
                    Stops = new List<Stop>()
                    {
                        new Stop (){ Name = "Atlanta, GA", Arrival = new DateTime(2014, 6, 4), Latitude = 33.5786786, Longitude =-84.0055, Order=0},
                        new Stop (){ Name = "New York, NY", Arrival = new DateTime(2014, 6, 9), Latitude = 40.22131, Longitude =-74.333000, Order=1},
                        new Stop (){ Name = "Boston, MA", Arrival = new DateTime(2014, 7, 1), Latitude = 42.5544, Longitude =-71.33201, Order=2},
                        new Stop (){ Name = "Chicago, IL", Arrival = new DateTime(2014, 7, 10), Latitude = 41.2555, Longitude =-87.22111, Order=3},
                        new Stop (){ Name = "Seatle, WA", Arrival = new DateTime(2014, 8, 13), Latitude = 47.28666, Longitude =-122.221100, Order=4 },
                        new Stop (){ Name = "Atlanta, GA", Arrival = new DateTime(2014, 8, 23), Latitude = 43.22555, Longitude =-84.3366620, Order=5 }
                    }
                };
